...
Whether you're a developer or QA engineer, Postmate helps you create, organize, and automate API tests without leaving your coding environment.
...
- **Data Tables** — nable data-driven API testing using CSV-style inputs. **In Postmate Client you can creare as many as data table you need**
