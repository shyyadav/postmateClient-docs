...
![Postmate Client running inside Visual Studio Code as a Postman alternative](/requestPanel.png)
...
![Compare API responses with semantic JSON diff in Postmate Client](/compare1.png)
...
![Data Table attached to environment in Postmate Client showing row selector and CSV import](/threeSteps.gif)
